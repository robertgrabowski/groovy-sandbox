...
public class Checker
{
    ...
    public static Object checkedCall(Integer interceptorId, Object _receiver, boolean safe, boolean spread,
            Object _method, Object... _args) throws Throwable
    {
        ...
        if (spread) {
            ...
            while (itr.hasNext()) {
                Object it = itr.next();
                if (it != null) {
                    r.add(checkedCall(interceptorId, it, true, false, _method, _args));
                }
            }
            return r;
        } else {
             ...
             * The third try:
             * 
             * Groovyc produces one CallSites instance per a call site, then pack them into a single
             * array and put them as a static field in a class. this encapsulates the actual method
             * dispatching logic.
             * 
             * Ideally we'd like to get the CallSite object that would have been used for a call,
             * but because it's packed in an array and the index in that array is determined only at
             * the code generation time, I can't get the access to it.
             * 
             * So here we are faking it by creating a new CallSite object.
             */
            final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
    ...
    public static Object checkedStaticCall(Integer interceptorId, Class _receiver, String _method, Object... _args)
            throws Throwable
    {
        final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
        return new VarArgInvokerChain()
    ...
    public static Object checkedConstructor(Integer interceptorId, Class _type, Object... _args) throws Throwable
    {
        final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
        return new VarArgInvokerChain()
        {
            public Object call(Object receiver, String method, Object... args) throws Throwable
            {
                if (chain.hasNext()) {
                    ...
                    return fakeCallSite("<init>").callConstructor(receiver, args);
                }
            }
        }.call(_type, null, _args);
    }

    public static Object checkedGetProperty(Integer interceptorId, Object _receiver, boolean safe, boolean spread,
            Object _property) throws Throwable
    {
        if (safe && _receiver == null) {
            return null;
        }
        if (spread) {
            ...
            while (itr.hasNext()) {
                Object it = itr.next();
                if (it != null) {
                    r.add(checkedGetProperty(interceptorId, it, true, false, _property));
                }
            }
            return r;
        } else {
    ...
    public static Object checkedSetProperty(Integer interceptorId, Object _receiver, Object _property, boolean safe,
            boolean spread, Object _value) throws Throwable
    {
        if (safe && _receiver == null) {
            return _value;
        }
        if (spread) {
            ...
            while (itr.hasNext()) {
                Object it = itr.next();
                if (it != null) {
                    checkedSetProperty(interceptorId, it, _property, true, false, _value);
                }
            }
            return _value;
        } else {
    ...
    public static Object checkedGetAttribute(Integer interceptorId, Object _receiver, boolean safe, boolean spread,
            Object _property) throws Throwable
    {
        if (safe && _receiver == null) {
            return null;
        ...
        if (spread) {
            ...
            while (itr.hasNext()) {
                Object it = itr.next();
                if (it != null) {
                    r.add(checkedGetAttribute(interceptorId, it, true, false, _property));
                }
            }
            return r;
        } else {
    ...
    public static Object checkedSetAttribute(Integer interceptorId, Object _receiver, Object _property, boolean safe,
            boolean spread, Object _value) throws Throwable
    {
        if (safe && _receiver == null) {
            return _value;
        ...
        if (spread) {
            ...
            while (itr.hasNext()) {
                Object it = itr.next();
                if (it != null) {
                    checkedSetAttribute(interceptorId, it, _property, true, false, _value);
                }
            }
        } else {
            final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
    ...
    public static Object checkedGetArray(Integer interceptorId, Object _receiver, Object _index) throws Throwable
    {
        final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
        return new SingleArgInvokerChain()
        {
    ...
    public static Object checkedSetArray(Integer interceptorId, Object _receiver, Object _index, Object _value)
            throws Throwable
    {
        final Iterator<GroovyInterceptor> chain = GroovyInterceptor.getApplicableInterceptors(interceptorId).iterator();
